...
- If the work is analytic/data-oriented, also read `references/analytic-work.md` and align with any existing `analytic-workbench` conventions
...
- For analytic specs, include review checkpoints, artifact outputs, and promotion criteria explicitly
...
- For analytic specs, make notebook vs promoted workflow boundaries explicit and define review/promotion stages
...
- For analytic specs, separate exploratory work, comparison/review work, and promotion/hardening work into different tasks
