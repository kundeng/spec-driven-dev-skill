...
1. Read `SPEC_DIR/requirements.md` to understand the requirements and scope. If `steering/` exists (`.windloop/steering/` or `.kiro/steering/`), read it for project-level context.
   If the spec is analytic/data-oriented, also read `references/analytic-work.md`.
...
6. Implement the task:
   ...
   - For analytic tasks, keep artifact outputs, review gates, and promotion boundaries aligned with the spec instead of improvising them
